    ...
    <div class="layui-layout layui-layout-admin">
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console" class="layui-this">
                                <a lay-href="/index/index/index-default">控制台</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="/index/index/homepage1">主页一</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="/index/index/homepage2">主页二</a>
                            </dd>
                        </dl>
                    </li>
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="grid">
                                ...
                                <dl class="layui-nav-child">
                                    ...
                                    <dd data-name="mobile"><a lay-href="component/grid/mobile.html">按移动端排列</a>
                                    </dd>
                                    ...
                                    <dd data-name="stack"><a lay-href="component/grid/stack.html">低于桌面堆叠排列</a>
                                    </dd>
                                    <dd data-name="speed-dial"><a lay-href="component/grid/speed-dial.html">九宫格</a>
                                    </dd>
                                </dl>
                            </dd>
                            <dd data-name="button">
                            ...
                            <dd data-name="upload">
                                ...
                                <dl class="layui-nav-child">
                                    <dd data-name="demo1">
                                        <a lay-href="component/upload/demo1.html"
                                           lay-text="上传功能演示一">功能演示一</a>
                                    </dd>
                                    <dd data-name="demo2">
                                        <a lay-href="component/upload/demo2.html"
                                           lay-text="上传功能演示二">功能演示二</a>
                                    </dd>
                                </dl>
                            </dd>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="/index/index/index-default" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
        <!-- 主体内容 end -->
        <!-- 辅助元素，一般用于移动设备下遮罩 -->
